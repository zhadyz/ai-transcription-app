            ...
            {showSettings && (
              ...
              >
                <div className="px-3 pb-3 pt-2 space-y-2.5" style={{ borderTop: "1px solid rgba(180, 120, 30, 0.2)" }}>
                  ...
                  {/* Quality - Model Size Selection */}
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-xs text-amber-200/50 font-medium">Quality</span>
                    <div className="flex gap-1.5">
                      <button
                        onClick={() => updateSettings({ modelSize: 'tiny' })}
                        className={`px-2.5 py-1 rounded-md text-xs font-medium transition-all ${
                          settings.modelSize === 'tiny'
                            ? 'bg-amber-600/40 text-amber-100 border border-amber-500/50'
                            : 'bg-white/5 text-white/50 border border-white/10 hover:bg-white/10'
                        }`}
                      >
                      ...
                      <button
                        onClick={() => updateSettings({ modelSize: 'small' })}
                        className={`px-2.5 py-1 rounded-md text-xs font-medium transition-all ${
                      ...
                      <button
                        onClick={() => updateSettings({ modelSize: 'medium' })}
                        className={`px-2.5 py-1 rounded-md text-xs font-medium transition-all ${
